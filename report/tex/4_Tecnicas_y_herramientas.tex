...
Usaremos \concept{git} por razones de documentación y conocimiento ya adquirido, aunque existen otros sistemas como subversion.
...
En el código se ha usado la documentación recomendada por la comunidad de python en el PEP 287, este recomienda usar \tool{reStructuredText} (rst).
