...
Esto busca facilitar el acceso a la solución de un problema común en el campo del aprendizaje automático que es la clasificación de imágenes. Esto se hace mediante \eng{Tensorflow}.
...
Para ilustrar cómo se resuelve el reto de añadir más servicios, se ha implementado un servicio que usa \eng{Deep Learning} para clasificar imágenes sobre un conjunto de clases, como por ejemplo Imagenet \cite{imnet}.