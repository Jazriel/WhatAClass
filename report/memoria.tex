...
\usepackage{cite}
\usepackage{listings}
\lstset{basicstyle=\ttfamily\small, showstringspaces=false}
...
\newcommand{\hfoot}[2]{\href{#1}{#2}\footnote{\href{#1}{#2: #1}.}}

\usepackage{xspace} \let\oldLaTeX\LaTeX \renewcommand{\LaTeX}{\oldLaTeX\xspace} 
...
\noindent\includegraphics[width=\textwidth]{cabecera.pdf}\vspace{1cm}%
  ...
  {%
    ...
    \begin{tabbing}
    Tutores: \= Dr. José Francisco Díez Pastor \kill
...
\begin{abstract}
Mineria de datos, aprendizaje automático, redes neuronales, clasificadores, aplicación web.
\end{abstract}
...
\begin{abstract}
\input{./tex/0b_AbstractEng}
\end{abstract}

\renewcommand*\abstractname{Keywords}
\begin{abstract}
Data mining, machine learning, neural nets, web application.
\end{abstract}
...
\include{./tex/6_Conclusiones_Lineas_de_trabajo_futuras}
