...
\begin{abstract}
Investigar es dificil -> investigar redes neuronales tambien -> se busca agilizar el proceso de investigación y estudio de nuevas tecnologias. En concreto se busca el poder obtener datos(serian residuales) a los cuales se les pueda aplicar mineria.
\end{abstract}
